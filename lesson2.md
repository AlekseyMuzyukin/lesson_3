...
git add - позволяет добавить изменённые/новые файлы в репозиторий.
git commit - позволяет подтвердить изменения в памяти программы GIT и оставить к ним описание.
...
## 6. Просмотр истории коммитов.
 ...
 git checkout master
 ```
 ## 7. добавили для ошибки
 ## 7. new age
 Вносим изменения в ветку
 
## 8.Клонировать существующий репозиторий гид из любого места.
...
## 10. для просмотра потеряшек
gid  reflog
игнорирование файлов,создание веток гид через бранч и (переходом -б(свитч -с)) слияние веток и разрешение конфликтов,удаление веток